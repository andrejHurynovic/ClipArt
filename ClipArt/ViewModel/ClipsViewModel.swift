...
class ClipsViewModel {
    ...
    @ObservationIgnored private var isCtrlShiftPressed = false
...
//                closePreviewWindowAndPaste()
    ...
    private func openWindow() {
        guard let openWindowAction = openWindowAction else { return }
        openWindowAction(id: "\(Bundle.main.bundleURL).preview")
    }
}
